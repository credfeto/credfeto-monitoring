...
- VictoriaMetrics was bound to 127.0.0.1 only, making it unreachable from any other host on the network; changed to bind on 0.0.0.0 so Telegraf agents and the reverse proxy can actually reach it.
### Changed
